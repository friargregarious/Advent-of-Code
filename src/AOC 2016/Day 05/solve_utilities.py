...
def report_puzzle(puzzle: aocd.models.Puzzle, result, part:str):
    ...
    if part.upper() == "A":
        if puzzle.answered_a: print(f"Part A: {puzzle.answer_a} (Completed)")
        else: print( "Part A:", result)

    elif part.upper() == "B":
        if puzzle.answered_b: print(f"Part B: {puzzle.answer_b} (Completed)")
        else: print( "Part B:", result)

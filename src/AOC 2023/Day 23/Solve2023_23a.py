"""
#                ADVENT OF CODE | 2023 | A LONG WALK | PART [A]               #
#                         adventofcode.com/2023/day/23                        #
# SOLVER: --------------------------------------------------- friargregarious #
# CONTACT: --------------------------------------- friar.gregarious@gmail.com #
# HOME: -------------------------------------------------------------- github #
# SOURCE: ---------------------------------- ~/Advent-of-Code/AOC 2023/Day 23 #
...
def solve_a(data):
    """For solving PART a of day 23's puzzle."""
    solution = data
